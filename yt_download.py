...
label_name = tk.Label(root, text="YouTube Video Downloader", font="arial 20 bold")
label_name.place(x=125, y=10)
link = tk.StringVar()
label_description = tk.Label(root, text="Paste Your Link Here", font="arial 15")
label_description.place(x=225, y=200)

entry = tk.Entry(root, width=95, textvariable=link)
entry.place(x=35, y=230)
...
def ready_window():
    ...
    tk.Label(ready, text="Downloaded", font="arial 20 bold").place(x=62, y=30)
    tk.Button(ready, text="OK", font="arial 15", bg="violet", padx=2,
...
tk.Button(root, text="EXIT", font="arial 15 bold", bg="grey", fg='white', padx=2,
       command=exit).place(x=285, y=310)
tk.Button(root, text="DOWNLOAD", font="arial 15", bg="violet", padx=2,
